  ...
  let handleSubmit = async (e) => {
    ...
    try {
      ...
      if(albumThumbnail){
        ...
        albumData.append("cloud_name","dmefey1m8");

        //! Upload album thumbnail to the cloudinary
        let response = await fetch("https://api.cloudinary.com/v1_1/dmefey1m8/upload",{
            method:"POST",
            body: albumData
        });
      ...
      await Promise.all(
        songDetails.map( async (song,index)=>{
            ...
            if(song.songThumbnail){
                ...
                songFileData.append("cloud_name","dmefey1m8");
                ...
                let uploadedSongThumbnailUrl = uploadedSongThumbnailResult.url;
            ...
            if(song.songFile){
                ...
                //! Upload song file (.mp3) to cloudinary
                //! Fetch API
                ...
                let uploadedSongFileUrl = uploadedSongFileResult.url;
                console.log("Song file Uploaded",uploadedSongFileUrl);
            ...
            songData.push({
                ...songDataObject,
                songThumbnail: uploadedAlbumThumbnailUrl,
